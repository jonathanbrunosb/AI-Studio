import { BarChart3, BookOpen, FileStack, LayoutTemplate, Send, Settings, Sparkles } from "lucide-react";
...
export const navigationItems = [
  ...
  { label: "Central de Publicações", href: "/publicacoes", icon: Send },
...
export function getPageTitle(pathname: string) {
  ...
  if (pathname === "/administracao/integracoes") return "Integrações";
